...
#pragma config(Motor,  motorA,          piston,        tmotorNXT, PIDControl, encoder)
...
void turn30CCW() //counter-clockwise
{
	...
	nMotorEncoderTarget[motorB] = 110; //set the target stoping position
	nMotorEncoderTarget[motorC] = -110;

	motor[motorB] = 25;
	motor[motorC] = -25; //turn both motors on at 100 percent power
